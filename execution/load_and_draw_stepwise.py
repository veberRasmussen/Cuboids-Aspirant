# execution/load_and_draw_building_stepwise.py
"""Load a building from file and visualize it step-by-step."""
...
from common.buildings.visualisation.draw_building_stepwise import draw_building_stepwise


def main():
    """Load building and display it step-by-step."""

    print("\n" + "=" * 70)
    print("LOAD AND VISUALIZE BUILDING (STEP-BY-STEP)")
    print("=" * 70 + "\n")
